...
public enum ExerciseEnum {
    ...
    BEGINNER_DAY_4("Push-ups", " Squats", " Sit-ups", " Mountain climber"),
    ...
    INTERMEDIATE_DAY_3("Burpees"," Box jumps"," High knees"," Mountain climber"," Tuck jumps"),
    ...
    INTERMEDIATE_DAY_7("Burpees"," Box jumps", "High knees", "Mountain climber"," Tuck jumps"),

    EXPERT_DAY_1("Plyo push-up"," Bench press"," Lat pulldowns"," Tricep dips"," Bicep curls"),
    EXPERT_DAY_2("Squats, Lunges"," Leg press"," Leg curls", "Calf raises"),
    EXPERT_DAY_3("Burpees", "Box jumps"," High knees"," Mountain climber"," Tuck jumps"),
    EXPERT_DAY_4("Deadlifts"," Step-ups"," Glute bridges"," Hip thrusts"," Plank"),
    EXPERT_DAY_5("Plyo push-up"," Bench press"," Lat pulldowns"," Tricep dips"," Bicep curls"),
    EXPERT_DAY_6("Squats, Lunges", "Leg press", "Leg curls", "Calf raises"),
    EXPERT_DAY_7("Burpees"," Box jumps"," High knees"," Mountain climber"," Tuck jumps"),

    FATLOSS_DAY_1("Jumping jacks", "High knees", "Butt kicks"," Plank jacks", "Side shuffles"),
    FATLOSS_DAY_2("Mountain climber", "Squat jumps"," Lunges"," Skaters"," Burpees"),
    ...
    FATLOSS_DAY_5("Squat jumps"," Lunges"," Mountain climber"," Skaters,Burpees"),
